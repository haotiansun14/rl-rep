...
class Encoder(nn.Module):
    ...
    def __init__(self, latent_dim=50, num_layers=4, num_filters=32):
        super().__init__()
...
class Decoder(nn.Module):
    def __init__(self, latent_dim, num_layers=4, num_filters=32):
        super().__init__()
...
class VAE1D(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.encoder = Encoder(args.latent_dim, args.ae_num_layers, args.ae_num_filters)
        self.decoder = Decoder(args.latent_dim, args.ae_num_layers, args.ae_num_filters)
