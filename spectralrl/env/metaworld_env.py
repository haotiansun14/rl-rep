...
class MetaWorld:
    ...
    def render(self):
        return self._env.sim.render(256, 256, mode="offscreen", camera_name=self._camera)
...
class metaworld_wrapper():
    ...
    def render(self):
        return self._env._env._env.render()
...
def make(name, frame_stack, action_repeat, seed):
    ...
    env = MetaWorld(task,seed,action_repeat,(84,84),'corner2')
